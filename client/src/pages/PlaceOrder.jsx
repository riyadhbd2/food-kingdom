...
const PlaceOrder = () => {
  ...
  return (
    <form className="flex flex-wrap items-start justify-center gap-12 mt-12 px-4">
      ...
      <div className="w-full md:w-2/4 lg:w-2/5 bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="flex gap-4">
          <input className="input-style flex-1" type="text" placeholder="City" />
          <input className="input-style flex-1" type="text" placeholder="State" />
        </div>

        {/* Zip Code & Country Flex Container */}
        <div className="flex gap-4">
          <input className="input-style flex-1" type="text" placeholder="Zip Code" />
          <input className="input-style flex-1" type="text" placeholder="Country" />
        </div>
